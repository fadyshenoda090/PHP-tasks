...
echo "username is: " . trim(strtoupper(strip_tags($_POST["username"]))) . "<br>";
...
<img src="<?= "img/" . $name ?>" alt="kak" height="200" width="200"> <br>
<button style="text-decoration: none; font-weight:500;margin-left:75px;height:20px;width:60px;"><a style="text-decoration: none; font-weight:500;" href="logout.php">Logout</a></button>